...
public class Seguro {
    ...
    public String toString() {
        return "Seguro{" + "nombreEmpresaSeguros=" + nombreEmpresaSeguros + ", fechaInicioCobertura=" + fechaInicioCobertura + ", fechaFinalizacionCobertura=" + fechaFinalizacionCobertura + ", descripcion=" + descripcion + ", idPanel=" + idPanel + '}';
    }
